$(document).ready(function () {
  ...
  $('.active-banner-slider').owlCarousel({
    ...
    nav: true,
    navText: [
      "<img src='http://127.0.0.1:5173/resources/assets/client/img/banner/prev.png'>",
      "<img src='http://127.0.0.1:5173/resources/assets/client/img/banner/next.png'>"
    ],
    dots: false
  });
  ...
  $('.active-product-area').owlCarousel({
    ...
    nav: true,
    navText: [
      "<img src='http://127.0.0.1:5173/resources/assets/client/img/product/prev.png'>",
      "<img src='http://127.0.0.1:5173/resources/assets/client/img/product/next.png'>"
    ],
    dots: false
  });
